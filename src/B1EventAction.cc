  ...
  for (G4int i=0; i<n_hit;i++)
   {
    // Get hits information
     ...
     analysisManager->FillNtupleFColumn(1,localPos[0] + 0.01); // Shift x by 1cm so goes from 0mm to 2mm
     analysisManager->FillNtupleFColumn(2,localPos[1] + 0.01); // Shift y by 1cm so goes from 0mm to 2mm
